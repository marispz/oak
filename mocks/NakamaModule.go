...
func (_m *NakamaModule) CronNext(expression string, timestamp int64) (int64, error) {
...
func (_m *NakamaModule) CronPrev(expression string, timestamp int64) (int64, error) {
	ret := _m.Called(expression, timestamp)
...
func (_m *NakamaModule) FriendsOfFriendsList(ctx context.Context, userID string, limit int, cursor string) ([]*api.FriendsOfFriendsList_FriendOfFriend, string, error) {
...
func (_m *NakamaModule) GetFleetManager() runtime.FleetManager {
	ret := _m.Called()
...
func (_m *NakamaModule) LeaderboardCreate(ctx context.Context, id string, authoritative bool, sortOrder string, operator string, resetSchedule string, metadata map[string]interface{}, enableRanks bool) error {
...
func (_m *NakamaModule) LeaderboardRanksDisable(ctx context.Context, id string) error {
	ret := _m.Called(ctx, id)
...
func (_m *NakamaModule) MultiUpdate(ctx context.Context, accountUpdates []*runtime.AccountUpdate, storageWrites []*runtime.StorageWrite, storageDeletes []*runtime.StorageDelete, walletUpdates []*runtime.WalletUpdate, updateLedger bool) ([]*api.StorageObjectAck, []*runtime.WalletUpdateResult, error) {
...
func (_m *NakamaModule) NotificationsDeleteId(ctx context.Context, userID string, ids []string) error {
...
func (_m *NakamaModule) NotificationsGetId(ctx context.Context, userID string, ids []string) ([]*runtime.Notification, error) {
	ret := _m.Called(ctx, userID, ids)
...
func (_m *NakamaModule) NotificationsList(ctx context.Context, userID string, limit int, cursor string) ([]*api.Notification, string, error) {
	ret := _m.Called(ctx, userID, limit, cursor)
...
func (_m *NakamaModule) NotificationsUpdate(ctx context.Context, updates ...runtime.NotificationUpdate) error {
...
func (_m *NakamaModule) StatusFollow(sessionID string, userIDs []string) error {
...
func (_m *NakamaModule) StatusUnfollow(sessionID string, userIDs []string) error {
	ret := _m.Called(sessionID, userIDs)
...
func (_m *NakamaModule) StorageIndexList(ctx context.Context, callerID string, indexName string, query string, limit int, order []string, cursor string) (*api.StorageObjects, string, error) {
...
func (_m *NakamaModule) TournamentRanksDisable(ctx context.Context, id string) error {
	ret := _m.Called(ctx, id)
...
func (_m *NakamaModule) UsersGetFriendStatus(ctx context.Context, userID string, userIDs []string) ([]*api.Friend, error) {
